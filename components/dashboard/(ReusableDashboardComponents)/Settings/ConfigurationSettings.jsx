...
export default function ConfigurationSettings() {
    ...
    const toggleSupportConfig = (key) => {
        ...
        const actionDisplay = key === 'dealer2FA' || key === 'enforce2FA' ? '2FA Requirement' : key.replace(/([A-Z])/g, ' $1').trim();
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start justify-between p-4 bg-[rgb(var(--color-background))] rounded-lg border border-[rgb(var(--color-border))]">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                ...
                                <h4 className="font-semibold text-[rgb(var(--color-text))] text-sm">Allow Bulk Delete</h4>
                            </div>
                            <p className="text-xs text-[rgb(var(--color-text-muted))]">Permit Support users to delete multiple items.</p>
                        </div>
                    ...
                    <div className="flex items-start justify-between p-4 bg-[rgb(var(--color-background))] rounded-lg border border-[rgb(var(--color-border))]">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-[rgb(var(--color-text-muted))]">Enforce 2FA for Dealer users.</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input
                                type="checkbox"
                    ...
                    <div className="flex items-start justify-between p-4 bg-[rgb(var(--color-background))] rounded-lg border border-[rgb(var(--color-border))]">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-[rgb(var(--color-text-muted))]">Require Two-Factor Auth for all Support users.</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input
                                type="checkbox"
