      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {themes.map((t) => {
          ...
          return (
            ...
            >
              <div
                className={`p-2 rounded-lg ${isActive ? 'bg-[rgb(var(--color-primary))] text-white' : 'bg-[rgb(var(--color-background))] text-[rgb(var(--color-text))]'}`}
              >
                <Icon size={24} />
              </div>
              <span
                className={`font-semibold text-sm ${isActive ? 'text-[rgb(var(--color-primary))]' : 'text-[rgb(var(--color-text))]'}`}
              >
                {t.label}
              </span>
            </button>
