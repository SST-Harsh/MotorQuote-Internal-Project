...
import { Search, Send, Edit, User, Eye, Plus } from 'lucide-react';
import Link from 'next/link';
import Swal from 'sweetalert2';
import Loader from '../../common/Loader';
import cmsService from '@/services/cmsService';

const AdminEmailListView = () => {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[rgb(var(--color-text-muted))]">
            View and test automated email templates.
          </p>
        </div>
        <Link
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-[rgb(var(--color-surface))] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            <div className="p-6 border-b border-[rgb(var(--color-border))]">
              <h2 className="text-xl font-bold">Send &quot;{selectedTemplate.name}&quot;</h2>
            ...
            <div className="p-4 border-t border-[rgb(var(--color-border))] bg-[rgb(var(--color-background))]/50 flex justify-end gap-3">
              <button
                ...
                disabled={isSending}
                className="px-4 py-2 rounded-lg text-sm font-medium text-[rgb(var(--color-text-muted))] hover:bg-[rgb(var(--color-primary-dark))] transition-colors disabled:opacity-50"
              >
                Cancel
              </button>
              <button
...
export default AdminEmailListView;
