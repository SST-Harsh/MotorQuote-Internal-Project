...
import { Plus, LayoutDashboard, Building2, FileText, ClipboardCheck, Users, UserCog, Settings, Shield, CheckCircle, XCircle, Trash2, Edit2, Eye, Activity, Mail, Phone } from "lucide-react";
...
const initialManagers = [
    { id: 'm-1', name: 'James Wilson', email: 'james@example.com', role: 'Manager', status: 'active', phone: '9876543210', joinedDate: 'Jan 12, 2024' },
    { id: 'm-2', name: 'Sarah Connor', email: 'sarah@example.com', role: 'Manager', status: 'active', phone: '8765432109', joinedDate: 'Feb 28, 2024' },
    { id: 'm-3', name: 'Michael Scott', email: 'michael@dunder.com', role: 'Manager', status: 'inactive', phone: '7654321098', joinedDate: 'Mar 15, 2024' },
    { id: 'm-4', name: 'Michael Scott', email: 'michael@dunder.com', role: 'Manager', status: 'pending', phone: '7654321098', joinedDate: 'Mar 15, 2024' },
];
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable
                ...
                filterOptions={[
                    { key: 'role', label: 'Role', options: [{ value: 'Manager', label: 'Manager' }, { value: 'Seller', label: 'Seller' }] },
