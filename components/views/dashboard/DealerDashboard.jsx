...
export default function DealerDashboard() {
  ...
  const urgentTickets = [
    {
      id: 'T-1023',
      subject: 'Login Issue at Metro Ford',
      customer: 'John Manager',
      priority: 'High',
      status: 'Open',
      created: '10 mins ago',
    },
    {
      id: 'T-1022',
      subject: 'Quote Sync Error',
      customer: 'Alice (Velocity)',
      priority: 'High',
      status: 'In Progress',
      created: '25 mins ago',
    },
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[rgb(var(--color-text-muted))] text-sm">
          Overview and performance stats
        </p>
      </div>
          ...
          columns={[
            {
              header: 'ID',
              accessor: 'id',
              className: 'font-mono text-xs text-[rgb(var(--color-text-muted))]',
            },
            ...
            { header: 'Customer', accessor: 'customer' },
            {
              ...
              accessor: (row) => {
                ...
                return (
                  <span
                    className={`px-2 py-0.5 rounded text-xs font-medium border ${colors[row.priority] || ''}`}
                  >
                    {row.priority}
                  </span>
                );
