    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const updates = {
                ...
                ...(uploadedAvatarUrl ? { avatar: uploadedAvatarUrl } : (avatarPreview && { avatar: avatarPreview }))
            };
            ...
            <div className="flex items-start gap-8 flex-col sm:flex-row mb-8">
                ...
                <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                        <label className="text-sm font-semibold text-[rgb(var(--color-text))]">First Name</label>
                        <input
                            type="text"
                            name="firstName"
                    ...
                    <div className="space-y-1 md:col-span-2">
                        <label className="text-sm font-semibold text-[rgb(var(--color-text))]">Email Address</label>
                        <input
                            type="email"
                            name="email"
                    ...
                    <div className="space-y-1 md:col-span-1">
                        <label className="text-sm font-semibold text-[rgb(var(--color-text))]">Phone Number</label>
                        <div className="relative">
                            <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[rgb(var(--color-text-muted))]" />
                            <input
                                type="tel"
                                name="phone"
