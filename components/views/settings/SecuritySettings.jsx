...
export default function SecuritySettings() {
  ...
  const renderPasswordInput = (name, label, placeholder) => (
    <div>
      <label className="block text-sm font-semibold text-[rgb(var(--color-text))] mb-1.5">
        {label}
      </label>
          ...
          {!showPasswordForm ? (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <h4 className="text-sm font-semibold text-[rgb(var(--color-text))]">
                  Change Password
                </h4>
                <button
                  type="button"
              ...
              <div className="flex justify-end pt-2">
                <button
                  type="submit"
                  className="bg-[rgb(var(--color-primary))] text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[rgb(var(--color-primary-dark))] shadow-lg shadow-[rgb(var(--color-primary)/0.3)] transition-all"
                >
                  Update Password
                </button>
              </div>
