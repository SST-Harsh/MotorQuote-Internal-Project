        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <p
                className={`font-bold text-sm leading-tight mb-0.5 ${idx === 0 ? 'text-white' : 'text-[rgb(var(--color-text))]'}`}
              >
                {action.label}
              </p>
              <p
                className={`text-[11px] font-medium ${idx === 0 ? 'text-white/80' : 'text-[rgb(var(--color-text))]'}`}
              >
                {action.description}
              </p>
            </div>
          ...
          <div
            className={`transform transition-transform duration-300 group-hover:translate-x-1 ${idx === 0 ? 'text-white' : 'text-[rgb(var(--color-text))]'}`}
          >
            <svg
              width="20"
              height="20"
