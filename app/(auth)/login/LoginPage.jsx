  ...
  return (
    <div className="flex min-h-screen bg-[rgb(var(--color-background))]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#19223a] text-white flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-20">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 bg-[rgb(var(--color-primary))] rounded-lg flex items-center justify-center font-bold text-white">M</div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-gradient-to-br   p-4 sm:p-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden z-10 
          ...
          <div className="relative h-64 md:h-auto lg:hidden bg-[#19223a]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 text-center z-10">
              <div className="w-12 h-12 bg-[rgb(var(--color-primary))] rounded-xl flex items-center justify-center font-bold text-2xl mb-4 shadow-lg shadow-[rgb(var(--color-primary)/0.3)]">M</div>
          ...
          <div className="p-8 md:p-10 lg:p-0 flex flex-col justify-center h-full">
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-semibold text-gray-900 lg:text-[rgb(var(--color-text))] mb-1.5">Work Email</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 lg:text-[rgb(var(--color-text))] mb-1.5">Password</label>
                <div className="relative group">
                  <Lock
                    className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[rgb(var(--color-primary))] transition-colors"
                    size={18}
              ...
              {errors.submit && (
                <div className="bg-[rgb(var(--color-error)/0.1)] border border-[rgb(var(--color-error)/0.2)] text-[rgb(var(--color-error))] text-sm p-3 rounded-lg flex items-start gap-2">
                  <span className="mt-0.5">⚠️</span><span>{errors.submit}</span>
                </div>
              )}
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  />
                  <span className="text-sm text-gray-500 lg:text-[rgb(var(--color-text-muted))] group-hover:text-gray-900 lg:group-hover:text-[rgb(var(--color-text))] transition-colors">Keep me logged in</span>
                </label>
              ...
              <div className="relative flex items-center justify-center my-6">
                ...
                <span className="relative bg-[rgb(var(--color-surface))] lg:bg-transparent px-4 text-xs text-[rgb(var(--color-text-muted))] uppercase tracking-wider font-semibold">Or continue with</span>
              </div>
              ...
              <div className="mt-8 text-center lg:hidden">
                <p className="text-xs text-[rgb(var(--color-text-muted))] opacity-70">© 2025 {companyName}. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
