...
export default function SuperAdminDashboard() {
  ...
  React.useEffect(() => {
    ...
    // 3. Conversions (Approved or Sold)
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/super-admin/dealerships?action=add" className="flex items-center gap-2 bg-[rgb(var(--color-primary))] text-white px-5 py-3 rounded-xl hover:bg-[rgb(var(--color-primary-dark))] transition-all shadow-lg shadow-[rgb(var(--color-primary)/0.3)] font-medium">
              <Plus size={20} />
              Add New Dealership
            </Link>
            <Link href="/super-admin/quotes?status=Pending" className="flex items-center gap-2 bg-[rgb(var(--color-surface))] text-[rgb(var(--color-text))] border border-[rgb(var(--color-border))] px-5 py-3 rounded-xl hover:bg-[rgb(var(--color-background))] transition-all font-medium">
